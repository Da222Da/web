...
<span class="line"><span style="color:#24292E;">	},</span></span>
<span class="line"><span style="color:#24292E;">};</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><h3 id="侦听-props-属性的变化" tabindex="-1">侦听 props 属性的变化 <a class="header-anchor" href="#侦听-props-属性的变化" aria-label="Permalink to &quot;侦听 props 属性的变化&quot;">​</a></h3><blockquote><p>注意，你不能直接侦听 props 的属性值，这里需要用一个返回该属性的 getter 函数。</p></blockquote><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-YRGqP" id="tab--eT-iJa" checked="checked"><label for="tab--eT-iJa">子组件 Children.vue</label><input type="radio" name="group-YRGqP" id="tab-JQGPZ7t"><label for="tab-JQGPZ7t">父组件 App.vue</label></div><div class="blocks"><div class="language-vue vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
